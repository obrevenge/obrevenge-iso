...
# Making Labels
        self.label = gtk.Label("This is a list of the default software selections. If this list is ok with you, there is no need to select your own software. Simply click the install button below. Internet: Firefox, Thunderbird  Office: LibreOffice, Evince PDF  Media: Gimp, Audacious, and VLC")
